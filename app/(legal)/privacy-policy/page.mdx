# Privacy Policy for AudioTextHub

## Introduction

Welcome to AudioTextHub, the smart text-to-speech platform designed to help you convert text to natural-sounding speech quickly and efficiently. At AudioTextHub, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using AudioTextHub:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use AudioTextHub, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access AudioTextHub, such as device type, operating system, and browser type.
...
**Copyright Owner**: [audiotexthub.pro](https://audiotexthub.pro)
**Email**: [xiaohuiaijiaolian@aimix.pro](mailto:xiaohuiaijiaolian@aimix.pro)

By using AudioTextHub, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
